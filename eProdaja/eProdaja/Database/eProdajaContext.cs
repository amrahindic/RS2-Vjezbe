...
namespace eProdaja.Database
{
    public partial class eProdajaContext : DbContext
    {
        ...
        public virtual DbSet<CovidPaso> CovidPasos { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CovidPaso>(entity =>
            {
            ...
            modelBuilder.Entity<Kupci>(entity =>
            {
                ...
                entity.HasIndex(e => e.CovidPasosId, "IX_Kupci_CovidPasosId");
                ...
                entity.HasOne(d => d.CovidPasos)
                    .WithMany(p => p.Kupcis)
                    .HasForeignKey(d => d.CovidPasosId);
            });
